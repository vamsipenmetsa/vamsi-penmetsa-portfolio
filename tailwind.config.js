  ...
  theme: {
    extend: {
      colors: {
        ...
        'dark-link': '#63b3ed',
        'dark-link-hover': '#90cdf4',
        'highlight-yellow': '#ffff88',
